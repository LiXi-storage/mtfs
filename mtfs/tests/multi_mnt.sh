...
test_10b() {
	...
	dd if=$DIR2/f10b of=$TMP/f10b-mtfs bs=4k count=1 || error "dd $DIR2"
	...
	cmp $TMP/f10b $TMP/f10b-mtfs || error "file miscompare"
	rm $TMP/f10b $TMP/f10b-mtfs $TMP/f10b-seed
}
...
test_18() {
	# $MMAP_SANITY -d $MTFS_MNT1 -m $MTFS_MNT2
