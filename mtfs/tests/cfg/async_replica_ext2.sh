...
JUNCTION_MODULE=${JUNCTION_MODULE:-mtfs_junction_async_replica_ext2}
JUNCTION_MODULE_PATH=${JUNCTION_MODULE_PATH:-${JUNCTION_COMMON_PATH}/async_replica_ext2/${JUNCTION_MODULE}.ko}
