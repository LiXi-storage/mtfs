...
LOWERFS_NAME=${LOWERFS_NAME:-"fuseblk"}
REMOVE_LOWERFS_MODULE=${REMOVE_LOWERFS_MODULE:-no}
MOUNT_LOWERFS=${MOUNT_LOWERFS:-yes}
LOWERFS_MODULE=${LOWERFS_MODULE:-"ntfs3g"}
LOWERFS_MOUNT_CMD=${LOWERFS_MOUNT_CMD:-"/sbin/mount.ntfs-3g -o streams_interface=xattr"}
...
LOWERFS_SUPPORT_DIR=${LOWERFS_SUPPORT_DIR:-`pwd`/../lowerfs/${LOWERFS_MODULE}}
LOWERFS_SUPPORT_MODULE=${LOWERFS_SUPPORT_MODULE:-mtfs_lowerfs_${LOWERFS_MODULE}}
...
JUNCTION_DIR=${JUNCTION_DIR:-`pwd`/../junctions/${SUBJECT_NAME}_${LOWERFS_MODULE}}
JUNCTION_MODULE=${JUNCTION_MODULE:-mtfs_junction_${SUBJECT_NAME}_${LOWERFS_MODULE}}
...
# Mount point 1 area
LOWERFS_MNT1=${LOWERFS_MNT1:-/mnt/${LOWERFS_MODULE}1}
LOWERFS_DEV=${LOWERFS_DEV:-/dev/sdc1}
...
# Mount point 2 area
LOWERFS_MNT2=${LOWERFS_MNT2:-/mnt/${LOWERFS_MODULE}2}
...
#
# Ntfs does not have native attr support.
#
LOWERFS_NO_ATTR=${LOWERFS_NO_ATTR:-yes}

#
# Ntfs does not have native mmap support.
#
LOWERFS_NO_MMAP=${LOWERFS_NO_MMAP:-yes}

#
# Tmpfs do not support xattr.
#
LOWERFS_NO_XATTR=${LOWERFS_NO_XATTR:-no}

#
# Tmpfs do not support trusted xattr.
#
LOWERFS_NO_TRUSTED_XATTR=${LOWERFS_NO_TRUSTED_XATTR:-yes}