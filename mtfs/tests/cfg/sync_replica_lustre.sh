...
LOWERFS_NAME_ARRAY=([0]=lustre)
LOWERFS_MNT_ARRAY=([0]="/mnt/${LOWERFS_NAME_ARRAY[0]}0")
LOWERFS_MOUNT_CMD_ARRAY=([0]="mount -t lustre")
LOWERFS_DEV_ARRAY=([0]="192.168.3.100@tcp:/server1")
LOWERFS_OPTION_ARRAY=([0]="-o user_xattr")

# Lowerfs module area
LOWERFS_MODULE_COMMON_PATH=${LOWERFS_COMMON_DIR:-`pwd`/../lowerfs}
LOWERFS_MODULE_ARRAY=([0]=mtfs_lowerfs_lustre)
LOWERFS_MODULE_PATH_ARRAY=([0]="${LOWERFS_MODULE_COMMON_PATH}/lustre/${LOWERFS_MODULE_ARRAY[0]}.ko")
...
JUNCTION_MODULE=${JUNCTION_MODULE:-mtfs_junction_sync_replica_lustre}
JUNCTION_MODULE_PATH=${JUNCTION_MODULE_PATH:-${JUNCTION_COMMON_PATH}/sync_replica_lustre/${JUNCTION_MODULE}.ko}
