...
LOWERFS_NAME=${LOWERFS_NAME:-ext2}
...
LOWERFS_SUPPORT_DIR2=${LOWERFS_SUPPORT_DIR2:-`pwd`/../lowerfs/tmpfs}
LOWERFS_SUPPORT_MODULE2=${LOWERFS_SUPPORT_MODULE2:-mtfs_lowerfs_tmpfs}
LOWERFS_SUPPORT_MODULE_PATH2=${LOWERFS_SUPPORT_MODULE_PATH2:-${LOWERFS_SUPPORT_DIR2}/${LOWERFS_SUPPORT_MODULE2}.ko}
...
JUNCTION_DIR=${JUNCTION_DIR:-`pwd`/../junctions/async_cache_ext}
...
LOWERFS_DEV=${LOWERFS_DEV:-/dev/sda4}
LOWERFS_OPTION=${LOWERFS_OPTION:-""}
MTFS_DIR1=${MTFS_DIR1:-/dev/shm/mtfs/dir1}
