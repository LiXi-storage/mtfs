...
JUNCTION_MODULE=${JUNCTION_MODULE:-mtfs_junction_async_cache_ext}
JUNCTION_MODULE_PATH=${JUNCTION_MODULE_PATH:-${JUNCTION_COMMON_PATH}/async_cache_ext/${JUNCTION_MODULE}.ko}
MTFS_OPTION=${MTFS_OPTION:-"-o subject=${SUBJECT_NAME_UPPER},checksum"}

# Mtfs Mount area
BRANCH_DIR_ARRAY=([0]="/dev/shm/mtfs/dir0"
