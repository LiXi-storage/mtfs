...
LOWERFS_SUPPORT_DIR=${LOWERFS_SUPPORT_DIR:-`pwd`/../lowerfs/ext}
LOWERFS_SUPPORT_MODULE=${LOWERFS_SUPPORT_MODULE:-mtfs_lowerfs_ext}
...
JUNCTION_MODULE=${JUNCTION_MODULE:-mtfs_junction_${SUBJECT_NAME}_ext}
...
LOWERFS_DEV=${LOWERFS_DEV:-/dev/sdb2}
