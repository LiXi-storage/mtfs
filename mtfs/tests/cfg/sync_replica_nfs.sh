...
LOWERFS_SUPPORT_MODULE=${LOWERFS_SUPPORT_MODULE:-mtfs_lowerfs_${LOWERFS_NAME}}
...
JUNCTION_DIR=${JUNCTION_DIR:-`pwd`/../junctions/${SUBJECT_NAME}_${LOWERFS_NAME}}
JUNCTION_MODULE=${JUNCTION_MODULE:-mtfs_junction_${SUBJECT_NAME}_${LOWERFS_NAME}}
...
LOWERFS_DEV=${LOWERFS_DEV:-120.219.90.152:/home/export/}
...
#
LOWERFS_NO_XATTR=${LOWERFS_NO_XATTR:-yes}