...
extern ssize_t ll_hrfs_file_sendfile(struct file *parent_file, int b_remain, hrfs_f_branch_t *barray, loff_t *ppos,
                                size_t count, read_actor_t actor, void *target);
extern ssize_t ll_hrfs_file_writev(struct file *parent_file, int b_remain, hrfs_f_branch_t *barray, const struct iovec *iov,
                              unsigned long nr_segs, loff_t *ppos);
extern ssize_t ll_hrfs_file_readv(struct file *parent_file, int b_remain, hrfs_f_branch_t *barray, const struct iovec *iov,
                              unsigned long nr_segs, loff_t *ppos);
