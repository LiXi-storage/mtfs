...
struct dentry *hrfs_ext4_lookup(struct inode *dir, struct dentry *dentry, struct nameidata *nd)
{
...
struct super_operations hrfs_ext4_sops =
{
...
struct inode_operations hrfs_ext4_symlink_iops =
{
...
struct inode_operations hrfs_ext4_dir_iops =
{
	create:	        hrfs_create,
	lookup:	        hrfs_ext4_lookup,
	link:           hrfs_link,
	unlink:	        hrfs_unlink,
...
struct inode_operations hrfs_ext4_main_iops =
{
	permission:     hrfs_permission,
	setattr:        hrfs_setattr,
	getattr:        hrfs_getattr,
...
struct dentry_operations hrfs_ext4_dops = {
	d_release:     hrfs_d_release,
};

struct file_operations hrfs_ext4_dir_fops =
{
...
struct file_operations hrfs_ext4_main_fops =
{
	llseek:     hrfs_file_llseek,
	read:       hrfs_file_read,
...
struct hrfs_operations hrfs_ext4_operations = {
	symlink_iops:            &hrfs_ext4_symlink_iops,
	dir_iops:                &hrfs_ext4_dir_iops,
	main_iops:               &hrfs_ext4_main_iops,
	main_fops:               &hrfs_ext4_main_fops,
	dir_fops:                &hrfs_ext4_dir_fops,
	sops:                    &hrfs_ext4_sops,
	dops:                    &hrfs_ext4_dops,
};
...
static int ext4_support_init(void)
{
	...
	HDEBUG("registering hrfs_ext4 support\n");
	...
	ret = junction_register(&hrfs_ext4_junction);
	if (ret) {
...
{
	HDEBUG("unregistering hrfs_ext4 support\n");
	lowerfs_unregister_ops(&lowerfs_ext4_ops);

	junction_unregister(&hrfs_ext4_junction);
}
