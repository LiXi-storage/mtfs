...
run_test 30 "run binary from hrfs (execve) ==================="
...
run_test 32e "stat d32e/symlink->tmp/symlink->hrfs-subdir ===="
...
run_test 32f "open d32f/symlink->tmp/symlink->hrfs-subdir ===="
...
run_test 32g "stat d32g/symlink->tmp/symlink->hrfs-subdir/${tdir}2"
...
run_test 32h "open d32h/symlink->tmp/symlink->hrfs-subdir/${tdir}2"
...
run_test 32m "stat d32m/symlink->tmp/symlink->hrfs-root ======"
...
run_test 32n "open d32n/symlink->tmp/symlink->hrfs-root ======"
...
run_test 32o "stat d32o/symlink->tmp/symlink->hrfs-root/$tfile"
...
run_test 32p "open d32p/symlink->tmp/symlink->hrfs-root/$tfile"
...
run_test 43c "md5sum of copy into hrfs========================"
...
run_test 54b "char device works in hrfs ======================"
...
run_test 54c "block device works in hrfs ====================="
...
run_test 54d "fifo device works in hrfs ======================"
...
run_test 54e "console/tty device works in hrfs ======================"
...
test_102a() {
	...
	# b10667: setting hrfs special xattr be silently discarded
	echo "set hrfs special xattr ..."
