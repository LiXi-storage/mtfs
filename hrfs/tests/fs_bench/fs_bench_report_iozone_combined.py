...
query = """select distinct(bench_id) from fs_bench where bench_program = 'iozone' order by bench_id desc limit 2""";
cursor=db.cursor();
...
for i in data:
	...
	if i > 0 and ( prev_file_size != file_size or prev_reclen != reclen):
		print """
			<tr>
				<td colspan="99"><br></td>
			</tr>
